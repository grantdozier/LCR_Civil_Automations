...
from api.routes import area_calculation, spec_extraction, dia_report, qa_review, proposals, demo
...
async def root():
    ...
    return {
        ...
        "modules": {
            ...
            "DEMO": "Complete DIA Workflow Demonstration",
        },
    }
...
app.include_router(
    ...
    tags=["DEMO - Complete DIA Workflow Demonstration"],
)
